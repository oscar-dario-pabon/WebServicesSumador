 ...
 * generated in the com.senneko.ws.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _SumarResponse_QNAME = new QName("http://main.ws.senneko.com/", "sumarResponse");
    private final static QName _Sumar_QNAME = new QName("http://main.ws.senneko.com/", "sumar");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.senneko.ws.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://main.ws.senneko.com/", name = "sumarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://main.ws.senneko.com/", name = "sumar")
